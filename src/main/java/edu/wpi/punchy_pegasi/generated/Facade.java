...
public class Facade {
    ...
    public <K, T, C> IDao<K, T, C> getDaoByClass(Class<T> clazz) {
        ...
        else if (clazz == edu.wpi.punchy_pegasi.generator.schema.LocationName.class)
            return (IDao<K, T, C>) locationNameDao;
        else if (clazz == edu.wpi.punchy_pegasi.generator.schema.RequestEntry.class)
            return (IDao<K, T, C>) requestEntryDao;
        else if (clazz == edu.wpi.punchy_pegasi.generator.schema.GenericRequestEntry.class)
            return (IDao<K, T, C>) genericRequestEntryDao;
        else if (clazz == edu.wpi.punchy_pegasi.generator.schema.FoodServiceRequestEntry.class)
            return (IDao<K, T, C>) foodServiceRequestEntryDao;
        else if (clazz == edu.wpi.punchy_pegasi.generator.schema.FlowerDeliveryRequestEntry.class)
            return (IDao<K, T, C>) flowerDeliveryRequestEntryDao;
        else if (clazz == edu.wpi.punchy_pegasi.generator.schema.ConferenceRoomEntry.class)
            return (IDao<K, T, C>) conferenceRoomEntryDao;
        else if (clazz == edu.wpi.punchy_pegasi.generator.schema.FurnitureRequestEntry.class)
            return (IDao<K, T, C>) furnitureRequestEntryDao;
        else if (clazz == edu.wpi.punchy_pegasi.generator.schema.OfficeServiceRequestEntry.class)
            return (IDao<K, T, C>) officeServiceRequestEntryDao;
