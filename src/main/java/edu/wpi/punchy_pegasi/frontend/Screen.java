...
public enum Screen {
    ...
    CONFERENCE_ROOM_SERVICE_REQUEST("Request Conference Room", "frontend/requests/ConferenceRoomRequest.fxml", Account.AccountType.NONE, ConferenceRoomController::create),
