...
import edu.wpi.punchy_pegasi.frontend.ConferenceRoomEntry;
...
public class ConferenceRoomController extends RequestController<ConferenceRoomEntry> {
    ...
    @FXML
    public void init() {
        //beginningTime.setItems(begTime);
        //endingTime.setItems(endTime);
        ObservableList<String> timeList = FXCollections.observableArrayList("12:00am","12:30am","1:00am", "1:30am",
                "2:00am", "2:30am",
                "3:00am", "3:30am",
                "4:00am", "4:30am",
                "5:00am", "5:30am",
    ...
    @FXML public void validateField(){
    ...
    public boolean timeCheck(ObservableList<String> timeList){
